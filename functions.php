...
// This function filters out all the custom fields
// generated by wordpress for each boss ladies custom post
function FM_filter_custom_fields($fieldName) {
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Author Picture/info', 'html5blank'),
        'id' => 'widget-area-2',
        'before_widget' => '<div id="%1$s" class="%2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h3>',
